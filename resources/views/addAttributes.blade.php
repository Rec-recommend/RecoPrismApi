              ...
              <div class="col-md-10 fields">
                <div class="row">
                  ...
                  <input type="number" class="form-control" name='attribute_1_weight'/>
                    ...
                    <div class="col">
                  <span class="btn input-group-addon add-field btn-default">+</span>
                    </div>
                </div>
...
$('.add-field').click(function() {
  count ++;
    var template = '<div class="row"><div class="col"><input type="text" class="form-control" name="attribute_'+ count + '"/></div>'+
                    ' <div class="col"><input type="number" class="form-control" name="attribute_'+ count + '_weight"/></div></div>',
    minusButton = '<span class="btn input-group-addon delete-field btn-danger">-</span>';
